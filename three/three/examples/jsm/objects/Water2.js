...
var Water = function (geometry, options) {
	...
	function updateTextureMatrix(camera, renderer) {
	...
	this.onBeforeRender = function (renderer, scene, camera) {
		...
		updateTextureMatrix(camera, renderer);
		updateFlow();
		...
		//
		reflector.modelMatrix = scope.modelMatrix;
		refractor.modelMatrix = scope.modelMatrix;
		...
		this.material.uniforms["tReflectionMap"].value = reflector.getRenderTarget(renderer).texture;
		scope.visible = true;
...
Water.WaterShader = {
	...
	fragmentShader: [
		...
		'   toEye=_CesiumNormal2ThreeNormal*toEye;',
		'#endif ',
