 ...
 */
	function FBXLoader( manager ) {
		...
		let onLoad=manager.onLoad
		manager.onLoad=function(){
			if(onLoad)	onLoad.call(manager);
			fbxTree=null
			sceneGraph=  connections=null; 
		}
	}
	...
	FBXTreeParser.prototype = {
		...
		parseTextures: function ( images ) {
			...
			if ( 'Texture' in fbxTree.Objects ) {
				...
				for ( var nodeID in textureNodes ) {
					...
					var cacheKey=this.getTextureKey(textureNode,images);
					var texture=textures[cacheKey] ;
					if(!texture){
						texture = this.parseTexture( textureNode, images );
		...
		getTextureKey(textureNode,images){
			...
			var wrapS = valueU === 0 ? RepeatWrapping : ClampToEdgeWrapping;
			var wrapT = valueV === 0 ? RepeatWrapping : ClampToEdgeWrapping;
